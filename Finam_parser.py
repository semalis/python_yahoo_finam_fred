...
start = "01.12.2017" #с какой даты начинать тянуть котировки
...
candles = pd.read_csv(urlopen(req))
candles.to_csv("Data/" + ticker + ".csv")

print("Готово. Проверьте файл {}.txt в папке где лежит скрипт".format(ticker))