...
# вызов micex=GetCandles ('MICEX', «15min», 10) вернет в переменную micex датафрейм, содержащий 15-ти
# минутные свечи индекса ММВБ за последние 10 дней, начиная с текущего момента времени.
